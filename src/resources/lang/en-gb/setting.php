...
return array(
	...
	'obs_billet_gateway2'		=> '- The "Payments" and "Balance" menu are dynamic',
	...
	'save_data'					=> 'Save Data',
	'default_pay_gate_boleto'	=> 'Default Billet Payment Gateway',
	...
	//Chaves dos gateways
	'pagarme_settings'			=> 'Pagar.me Settings V5',
	...
	'mercadopago_settings'		=> 'Mercado Pago Settings',
	'pagarapido_settings'		=> 'Paga Rápido Settings',
	...
	'pagarme_api_key'			=> 'Pagar.me Public Key',
	...
	'ipag_expiration_time'		=> 'Pix Expiration Time (min)',
	...
	'banco_inter_settings'		=> 'Banco Inter Settings',
	'banco_inter_account'		=> 'Banco Inter account number',
	'cnpj_for_banco_inter'		=> 'CNPJ',
	'banco_inter_crt'			=> 'Certificate File',
	'banco_inter_key'			=> 'Key File',

	'ipag_settings'				=> 'Ipag Settings',
	'juno_settings'				=> 'Juno Settings',
	'juno_client_id'			=> 'Client ID',
	'juno_secret'				=> 'Secret (Client Secret)',
	'juno_resource_token'		=> 'Resource Token (private token)',
	...
	'card_success_added'		=> 'Card Successfully Added',
	...
	'payment_direct_pix_msg'	=> 'Pix is performed in the users bank app at the end of the request, using the pix key that the provider provides to the customer. The flow is similar to payment by Cash or Card Machine.',
	'payment_gateway_pix'		=> 'Pix Gateway',
	'payment_gateway_pix_msg'	=> 'Pix is performed at the users bank at the end of the request, using the "Copy and Paste" pix key provided by the app or by scanning the QR code available on the providers app. For this type of pix, a Payment Gateway is required.',
	'default_pay_gateway_pix'	=> 'Default Payment Gateway for Pix',
	'prepaid_pix'				=> 'Prepaid Pix Gateway',
	'obs_pix_prepaid'			=> '- Payments per pix need payment gateway.',
	'pix_key'					=> 'Random Pix Key',
	'list_webhooks'				=> 'Webhooks',
	
	'pix_juno_settings'			=> 'Juno Settings',
	'pix_juno_client_id'		=> 'Client ID',
	'pix_juno_secret'			=> 'Secret (Client Secret)',
	'pix_juno_resource_token'	=> 'Resource Token (private token)',
